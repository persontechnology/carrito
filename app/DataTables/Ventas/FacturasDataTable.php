...
class FacturasDataTable extends DataTable
{
    ...
    {
        return $model->where('tipo',$this->tipo)->whereYear('created_at', '=', Auth::user()->anio);
    }
    ...
    protected function getColumns()
    {
        return [
            Column::computed('action')
                  ...
                  ->title('Opciones'),
            // Column::make('id'),
            Column::make('numero')->title('# '.$this->tipo),
            Column::make('total_factura')->title('Total'),
            Column::make('created_at')->title('Fecha'),
            Column::make('cliente_id')->title($this->tipo==='Ingreso'?'Proveedor':'Cliente'),
