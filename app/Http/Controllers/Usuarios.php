...
class Usuarios extends Controller
{
    ...
    {
        $data = array('roles'=>Role::where('name','!=','Administrador')->get(),'departamentos'=>Departamento::get());
    ...
    public function editar($idUser)
    {
        ...
        $data = array('user' => $user,'roles'=>Role::where('name','!=','Administrador')->get(),'departamentos'=>Departamento::get() );
