                ...
                <div class="card-body">
                    <form action="{{ route('actualizarProducto') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            <div class="col-md-4">
                                <div class="md-form md-outline my-1">
                                    <input id="cuenta_contable" name="cuenta_contable" class="form-control @error('cuenta_contable') is-invalid @enderror" value="{{ old('cuenta_contable',$pro->cuenta_contable) }}"  required  type="text">
                            ...
                            <div class="col-md-4">
                                <div class="md-form md-outline my-1">
                                    <input id="cuenta_salida" name="cuenta_salida" class="form-control @error('cuenta_salida') is-invalid @enderror" value="{{ old('cuenta_salida',$pro->cuenta_salida) }}" required type="text">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="custom-control custom-checkbox my-2">
                                    ...
                                    <label class="custom-control-label" for="defaultLoginFormRemember">Incluye IVA {{ $pro->incluye_iva }}</label>
                                    @error('incluye_iva')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
