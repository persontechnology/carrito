...
@section('breadcrumbs', Breadcrumbs::render('buscarFechaFechaFactura',$tipo))
@section('content')
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <p>Buscar {{ $tipo }} del año {{ Auth::user()->anio }}</p>
                    <form action="{{ route('buscarFechaFechaFactura') }}" class="mt-3" method="get">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col">
                                <button type="submit" class="btn btn-dark my-0"  >Buscar {{ $tipo }}</button>
                            </div>
                        </div>
                    </form>
                </div>
                ...
                <div class="card-body">
                            ...
                            <table class="table table-sm" id="tableFactura">
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td colspan="6">
                                            <p>
                                                <span class="badge badge-pill badge-light">{{ $tipo }} entregadas: {{ $facturas_entregadas }}</span>
                                                <span class="badge badge-pill badge-dark">{{ $tipo }} anuladas: {{ $facturas_anulados }}</span>
                                            </p>
                                        </td>
                                        <td>
                    ...
                    @else
                        <div class="alert alert-dark" role="alert">
                            No existe {{ $tipo }} con fechas desde: {{ $desde }} hasta: {{ $hasta }}
                        </div>
                    @endif
